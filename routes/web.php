...
Route::get('/clear/config', 'ConfigController@clearConfigCache');
Route::get('/clear/app', 'ConfigController@clearAppCache');
Route::get('/clear/view', 'ConfigController@clearViewCache');
