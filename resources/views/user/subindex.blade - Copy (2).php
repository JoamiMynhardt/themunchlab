   ...
   <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link rel="shortcut icon" href="{{asset('public/favicon.png')}}">
      ...
      <link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
         ...
         <link rel="stylesheet" type="text/css" href="{{asset('assets/css/style.css').'?version=232132'}}">
         @else
           <link rel="stylesheet" type="text/css" href="{{asset('assets/css/rtl.css').'?version=56565'}}">
         @endif
         ...
         <div class="footer">
            ...
            <div class="right">
               <div class="container">
                  <div class="row">
                     <div class="col-md-6">
                        <h1>{{__('messages.copyright')}} © {{Session::get('current_year')}} The Munch Lab. {{__('messages.f1')}}.</h1>
                     </div>
