            ...
            <div class="contact-head-1">
               ...
               <div class="f-location col-md-12 p-0">
                  ...
                  <div class="col-md-10 col-10 co-add">
                     <p> 13 Kearsney College Rd <br> Bothas Hill</p>
                  </div>
               </div>
               ...
               <div class="f-location col-md-12 p-0">
                  ...
                  <div class="col-md-10 col-10 co-add">
                     <p><a class="contact-email" href="mailto:info@themunchlab.com">info@themunchlab.com</a></p>
                  </div>
               </div>
               </p>
            </div>
...
<?php echo $__env->make('user.indexnew', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\themunchlab\resources\views/user/contact.blade.php ENDPATH**/ ?>