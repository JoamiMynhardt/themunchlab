...
<div class="container">
    ...
    <div class="about-history-1">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <img src="<?php echo e('public/upload/web/about1.jpeg'); ?>" class="about-image-1 img-responsive">
        </div>
    </div>
</div>
<div class="about-history-1">
    <div class="row">
        <div class="col-lg-4 col-md-4">
            <img src="<?php echo e('public/upload/web/sec-img.png'); ?>" width="100%">
        </div>
...
<?php echo $__env->make('user.indexnew', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\themunchlab\resources\views/user/about.blade.php ENDPATH**/ ?>