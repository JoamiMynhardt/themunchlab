                  ...
                  <div class="tabdiv">
                     ...
                     <div class="row">
                         <div class="form-group col-md-3" >
                             <img src="<?php echo e(asset('public/upload/web').'/'.$data->logo); ?>" class="webimage" />
                         </div>
                     ...
                     <div class="row">
                         <div class="form-group col-md-3" >
                             <img src="<?php echo e(asset('public/upload/web').'/'.$data->second_sec_img); ?>" class="webimage"/>
                         </div>
                         <div class="form-group col-md-9">
                     ...
                     <div class="row">
                         <div class="form-group col-md-3" >
                             <img src="<?php echo e(asset('public/upload/web').'/'.$data->secong_icon_img); ?>" class="webimage" />
                         </div>
                         <div class="form-group col-md-9">
                     ...
                     <div class="row">
                         <div class="form-group col-md-3" >
                             <img src="<?php echo e(asset('public/upload/web').'/'.$data->footer_up_img); ?>" class="webimage" />
                         </div>
                         <div class="form-group col-md-9">
                     ...
                     <div class="row">
                         <div class="form-group col-md-3" >
                             <img src="<?php echo e(asset('public/upload/web').'/'.$data->footer_img); ?>" class="webimage"/>
                         </div>
                         <div class="form-group col-md-9">
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\themunchlab\resources\views/admin/setting.blade.php ENDPATH**/ ?>